import { type HookErrorCode, type HookLogger } from '@platform-hub/core-sdk';
import type { HookPageDefinition } from '@platform-hub/core-sdk';
...
export declare function schedulerErrorResult(error: unknown): import("@platform-hub/core-sdk").HookError;
