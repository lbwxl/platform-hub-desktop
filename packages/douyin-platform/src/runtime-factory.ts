import { PageHookRuntimeAdapter, type PageRuntimeEvent, type PageRuntimePort } from '@platform-hub/core-runtime'
import type { PlatformAccountRecord, PlatformDefinition, PlatformRuntimeHostContext, PlatformRuntimeFactory } from '@platform-hub/core-runtime'
