...
- Orders: the persistent commerce page polls the same-origin official `/api/order/searchlist` endpoint; the primary page only resolves conversation-scoped order context when needed
