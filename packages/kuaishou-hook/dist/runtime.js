if (typeof window !== 'undefined') (() => {
  ...
  window[QUEUE_KEY] = {
    ...
    capabilities: ["messages.listen","messages.history","messages.send","messages.file","sessions.list","products.collect","products.detail","orders.read","orders.listen","session.transfer"],
    getAuthState: auth,
    collectProducts,
    getProductDetail,
    listSessions,
